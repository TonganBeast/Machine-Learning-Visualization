...
MD_Graph& MD_Graph::operator=(MD_Graph&& other) {
	...
	this->numMD_Points = other.numMD_Points;
	this->reuseDimension = other.reuseDimension;
	this->dimCombos = other.dimCombos;
	this->pts = other.pts;
	this->uniqueClassifications = other.uniqueClassifications;
	this->classificationForPoints = other.classificationForPoints;
	for(int i = 0; i < numPlanes; i++)
		this->planes[i] = other.planes[i].getPlane();
